...
const uri =
  "mongodb+srv://myDestist:goodpassword@cluster0.tawtw.mongodb.net/?retryWrites=true&w=majority";
...
client.connect((err) => {
  ...
  app.post("/appointmentsByDate", (req, res) => {
    ...
    collection.find({ appointmentDate: date.date }).toArray((err, document) => {
      res.send(document);
    });
  });
